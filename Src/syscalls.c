...
int _read(int file, char *ptr, int len) { (void)file; for (int i = 0; i < len; i++) *ptr++ = __io_getchar(); return len; }
int _write(int file, char *ptr, int len) { (void)file; for (int i = 0; i < len; i++) __io_putchar(*ptr++); return len; }
